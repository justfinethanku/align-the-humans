...
/**
 * New Alignment Error State
 *
 * Displayed when an error occurs while creating a new alignment
 * Provides option to retry or return to dashboard
 */
export default function NewAlignmentError({
  error,
  reset,
}: {
  ...
  useEffect(() => {
    ...
    console.error('New alignment error:', error);
  }, [error]);
      ...
      <div className="flex max-w-md flex-col items-center gap-6 text-center">
        ...
        <div className="space-y-2">
          ...
          <p className="text-sm text-slate-600 dark:text-slate-400">
            We encountered an error while creating your alignment. Please try again.
          </p>
          {error.message && (
